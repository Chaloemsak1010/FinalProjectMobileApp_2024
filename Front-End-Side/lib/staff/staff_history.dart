...
class _StaffHistoryState extends State<StaffHistory> {
  ...
  Future<void> getStaffHistory() async {
    ...
    // API endpoint
    final url = Uri.parse('http://10.0.2.2:3000/staff/history');
    ...
    if (response.statusCode == 200) {
      ...
      _showSnackbar("Failed to load data and status code is: ${response.statusCode}");
